...
plt.rcParams['animation.ffmpeg_path'] = r'/usr/bin/ffmpeg /usr/share/ffmpeg /usr/share/man/man1/'




def load_rle(pattern,shapeY,pos,trim=False,rH=False, rV=False, tp=False):
    ...
    * trim : trim edges for nicer plot    
    ...
    B = readRLE("data/GoL/rle/"+pattern+".rle", shape, pos,rH=rH,rV=rV, tp=tp)    
